...
public class WeedTypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scrolling_weed);
        inittilaztion();
    }
    ...
    private void inittilaztion() {
        ...
        WeedOrdersAdapter pastOrdersAdapter = new WeedOrdersAdapter(WeedTypeActivity.this);
                ...
                if (Math.abs(verticalOffset) - appBarLayout.getTotalScrollRange() == 0) {
                    ...
                    relativeLayout.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            collapsingToolbar.setTitle("Beleave");
                        }
                    });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(WeedTypeActivity.this, SampleActivity.class);
