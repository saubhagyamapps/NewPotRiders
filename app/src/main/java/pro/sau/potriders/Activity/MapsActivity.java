...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    ...
    private void inittilazation() {
        backArrowMap = (ImageView) findViewById(R.id.backArrowMap);
    ...
    private void drawroute() {
        start = new LatLng(23.039800, 72.555001);
        //waypoint = new LatLng(18.01455, -77.499333);
        end = new LatLng(23.037423, 72.528539);
